...
class TwoCardRow extends StatelessWidget {
  final String deaths;
  final String recovered;
  final ThemeData theme;
  TwoCardRow(
      {@required this.deaths, @required this.recovered, @required this.theme});
          ...
          children: <Widget>[
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    calc(int.parse(active) - int.parse(critical),
                        int.parse(active)),
                    style: TextStyle(
                  ...
                  Text(
                    calc(int.parse(critical), int.parse(active)),
                    style: TextStyle(
                      fontSize: SizeConfig.safeBlockHorizontal * 4,
                    ),
                  ),
